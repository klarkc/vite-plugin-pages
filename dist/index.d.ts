...
declare function generateRoutes(filesPath: string[], pagesDirOptions: PageDirOptions, options: ResolvedOptions): Route[];

declare function pagesPlugin(userOptions?: UserOptions): Plugin;

export default pagesPlugin;
export { ImportMode, ImportModeResolveFn, PageDirOptions, ResolvedOptions, Route, UserOptions, generateRoutes };
